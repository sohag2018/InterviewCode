 ...
 *7.using Collections.synchronizedMap() and type cast to make HashMap Sycronized*/
import java.util.Map;
import java.util.Collections;
import java.util.HashMap;
public class SyncHashMap implements Runnable {
	// creating map:
	Map<String, String> map = Collections.synchronizedMap(new HashMap<>());//using synchronizedMap() and type casting
	...
	public static void main(String[] args) {
		SyncHashMap sm = new SyncHashMap(); //creating obj of SyncroMapSimple 
        //creating threads
